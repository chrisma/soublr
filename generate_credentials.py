...
"""
Taken from https://github.com/mouhtasi/pytumblr/blob/ac1a240070570ea903603bb8daa701af078b8dd1/interactive_console.py
Modified to check for errors.
"""
...
def new_oauth(json_path):
        ...
        oauth_verifier = redirect_response.split('&')[-1].lstrip('oauth_verifier=').rstrip('#_=_')
